  ...
  return (
    <div className="d-flex flex-column h-100" style={{ minHeight: "100vh" }}>
      <div className="p-3 border-bottom">
        <div className="small text-muted">{t("console.organization")}</div>
        <div className="fw-semibold text-truncate">{user?.org_name}</div>
      ...
      <Nav className="flex-column p-3 flex-grow-1">
        ...
        >
          ...
          {t("console.notifications")}
        </Nav.Link>

        {hasPermission("members:read") && (
          <Nav.Link
            href="/console/org"
            active={pathname === "/console/org"}
            className="mb-2 rounded"
          >
            <svg
              className="me-2"
      ...
      <div className="p-3 border-top">
        <div className="mb-3">
          <div className="small text-muted">{t("settings.signedInAs")}</div>
