...
interface AuthContextType {
  ...
  loading: boolean;
  signup: (email: string, password: string, inviteCode?: string, orgName?: string) => Promise<void>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signup = async (email: string, password: string, inviteCode?: string, orgName?: string) => {
    const data = await signupApi(email, password, inviteCode || undefined, orgName || undefined);
